/**
 * TJ Control Panel V6 - Google Apps Script
 * 
 ...
 * - Simpler, more reliable architecture than V5 custom pivot
 * 
 * V4/V5 FEATURES:
...
function onOpen() {
  ...
  ui.createMenu('Control Panel')
    ...
    .addSeparator()
    .addSubMenu(ui.createMenu('📊 Pivot Table (V6)')
...
/**
 * onEdit trigger handler - handles checkbox clicks in Pivot View for Dashboard navigation
 * 
 * When a checkbox in the 📊 column is checked:
 * 1. Gets the campaign info from that row (using Campaign ID from the same row)
...
function refreshControlPanel() {
  ...
  try {
    ...
    Logger.log(`🚀 OPTIMIZED V6 - Processing ${campaignIds.length} campaigns`);
...
// ============================================================================
// PIVOT TABLE FUNCTIONS (V6) - Native Google Sheets Pivot Table
// ============================================================================
