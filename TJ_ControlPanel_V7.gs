/**
 * TJ Control Panel V7 - Google Apps Script
 * 
 ...
 * - Multi-select comparison: Compare up to 3 items with overlaid chart and side-by-side table
 * - Breakdown tables: See child items with vs Yesterday comparison
 * - Country filtering: Filter campaigns by targeted countries
 * 
 * V6 FEATURES:
...
function onOpen() {
  ...
  ui.createMenu('Control Panel')
    ...
    .addSeparator()
    .addSubMenu(ui.createMenu('📊 Pivot Table (V7)')
    ...
    .addSubMenu(ui.createMenu('📊 Dashboard (V7)')
      .addItem('📥 Pull Daily Stats (Campaign)', 'cpPullDailyStats')
      .addItem('📥 Pull Daily Stats (Spot Level)', 'cpPullDailyStatsSpotLevel')
      .addSeparator()
      .addItem('📈 Build Dashboard V7', 'cpBuildDashboardV7')
      .addItem('📈 Build Dashboard (Legacy)', 'cpBuildDashboard'))
    .addSeparator()
